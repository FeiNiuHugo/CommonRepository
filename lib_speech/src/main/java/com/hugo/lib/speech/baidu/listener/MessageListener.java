...
import com.hugo.lib.speech.baidu.Logger;
...
public class MessageListener implements SpeechSynthesizerListener {
    ...
    private ISpeakListener mSpeakLisstener;
    public boolean mIsSpeaking;


    public MessageListener(ISpeakListener listener) {
        this.mSpeakLisstener = listener;
    }

    public void setSpeakLisstener(ISpeakListener speakLisstener) {
        mSpeakLisstener = speakLisstener;
    }
    ...
    public void onSpeechFinish(String utteranceId) {
        mIsSpeaking = false;
        if (mSpeakLisstener != null) {
            mSpeakLisstener.onSpeakOver("");
        }
    ...
    public void onError(String utteranceId, SpeechError speechError) {
        mIsSpeaking = false;
        if (mSpeakLisstener != null) {
            mSpeakLisstener.onSpeakOver("error:" + speechError.code + " / " + speechError.description);
        }
